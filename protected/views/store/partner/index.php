...
<!--              <input type="hidden" name="oid" value="00D1a000000KEiH">
              ...
              <div class="content-section-headings">
                <h3 class="content-section-header merchant-title">Become a Partner</h3>
              ...
              <div class="form-group has-feedback">
                <label for="company" class="col-xs-4 control-label">Store Name</label>
                <div class="col-xs-8">
                ...
                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="company" data-bv-result="NOT_VALIDATED" style="display: none;">Please enter a value</small></div>
              </div>
              <div class="form-group has-feedback">
                <label for="first_name" class="col-xs-4 control-label">Contact Name</label>
                <div class="col-xs-8">
                  <input type="text" class="form-control" id="first_name" name="first_name" placeholder="John Doe" required="" data-bv-field="first_name"><i class="form-control-feedback" data-bv-icon-for="first_name" style="display: none;"></i>
                  <span class="help-block"></span>
              ...
              <div class="form-group has-feedback">
                <label for="phone" class="col-xs-4 control-label">
                  Cell Phone</label>
                <div class="col-xs-8">
                  <input type="text" class="form-control" id="phone" name="phone" placeholder="(XXX) XXX-XXXX" data-bv-phone="true" data-bv-phone-country="US" required="" data-bv-field="phone"><i class="form-control-feedback" data-bv-icon-for="phone" style="display: none;"></i>
                  <span class="help-block"></span>
                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="phone" data-bv-result="NOT_VALIDATED" style="display: none;">Please enter a value</small>
                <small class="help-block" data-bv-validator="phone" data-bv-for="phone" data-bv-result="NOT_VALIDATED" style="display: none;">Please enter a valid phone number</small>
                </div>
              </div>
              <div class="form-group has-feedback">
                <label for="email" class="col-xs-4 control-label">Email</label>
                <div class="col-xs-8">
                  <input type="email" class="form-control" id="email" name="email" placeholder="jdoe@gmail.com" required="" data-bv-field="email"><i class="form-control-feedback" data-bv-icon-for="email" style="display: none;"></i>
                  <span class="help-block"></span>
              ...
              <div class="form-group has-feedback">
                ...
                <div class="col-xs-8">
                  ...
                  <span class="help-block"></span>
                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="city" data-bv-result="NOT_VALIDATED" style="display: none;">Please enter a value</small></div>
              </div>

              <div class="form-group has-feedback">
                <label for="region" class="col-xs-4 control-label">Region</label>
                <div class="col-xs-8">
                  ...
                  </select><i class="form-control-feedback" data-bv-icon-for="00N1a000006s8Mz" style="display: none;"></i>
                  <span class="help-block"></span>
                <small class="help-block" data-bv-validator="notEmpty" data-bv-for="00N1a000006s8Mz" data-bv-result="NOT_VALIDATED" style="display: none;">Please enter a value</small></div>
              </div>
          ...
          <div class="col-sm-6 col-sm-pull-6 delivery-connect">
            <h3 class="merchant-title">Delivery Connects</h3>
            <p>
